...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A first edition, printed once, for exactly one reader." },
      { name: "author", content: "Drishti" },
      { property: "og:title", content: "YOU — A First Edition" },
      { property: "og:description", content: "A first edition, printed once, for exactly one reader." },
